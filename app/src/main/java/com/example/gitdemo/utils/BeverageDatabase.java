...
//    public static synchronized BeverageDatabase getInstance(Context context) {
//        if (instance == null) {
...
//    }
    ...
    private static class PopulateDbAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            beverageDao.insertBeverage(new Beverage("Cà phê Sữa", "https://f1.pngfuel.com/png/754/802/392/ice-cream-iced-coffee-vietnamese-iced-coffee-vietnamese-cuisine-pho-milkshake-drink-evaporated-milk-png-clip-art-thumbnail.png"
                    , 22000));
